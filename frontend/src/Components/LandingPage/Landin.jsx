...
export const Landigpage = () => {
  ...
  return <>{isLoggedIn ? <HeroCarousel /> : <Banner />}</>;
};
                ...
                <div>
                  <div>
                    ...
                    <div className="topic">
                      ...
                      <span>20,000,000 students</span>
                    </div>
                    <div className="topic">
                      <Link className="trendlink" to={"#"}>
                        React
                      </Link>
                      <span>15,000,000 students</span>
                    </div>
                  </div>
                  <div>
                    <h3>Business</h3>
                    <div className="topic">
                      ...
                      <span>1,200,000 students</span>
                    </div>
                    <div className="topic">
                      <Link className="trendlink" to={"#"}>
                        SQL
                      </Link>
                      <span>5,000,000 students</span>
                    </div>
                    <div className="topic">
                      <Link className="trendlink" to={"#"}>
                        PMP
                  ...
                  <div>
                    ...
                    <div className="topic">
                      ...
                      <span>6,000,000 students</span>
                    </div>
                    <div className="topic">
                      <Link className="trendlink" to={"#"}>
                        Ethical Hacking
                      </Link>
                      <span>10,000,000 students</span>
                    </div>
                    <div className="topic">
                      <Link className="trendlink" to={"#"}>
                        Cyber Security
                      </Link>
                      <span>1,500,000 students</span>
                    </div>
                  </div>
                  <div>
                    <h3>Design</h3>
                    <div className="topic">
                      ...
                      <span>11,000,000 students</span>
                    </div>
                    <div className="topic">
                      <Link className="trendlink" to={"#"}>
                        Graphic Design
                      </Link>
                      <span>7,000,000 students</span>
                    </div>
                    <div className="topic">
                      <Link className="trendlink" to={"#"}>
                        Drawing
                      </Link>
                      <span>2,000,000 students</span>
                    </div>
                  </div>
                </div>
